...
class PickMediaNewsWidget extends StatelessWidget {
  const PickMediaNewsWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        GestureDetector(
          onTap: () {
            AddNewsCubit.get(context).pickMedia();
          },
          child: SizedBox(
            height: 80.r,
            width: 80.r,
          ...
          child: SizedBox(
            ...
            child: BlocBuilder<AddNewsCubit, AddNewsState>(
              builder: (context, state) {
                List<MyMedia> media = AddNewsCubit.get(context).media;
                        ...
                        children: [
                          ...
                          PositionedDirectional(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                AddNewsCubit.get(context).deleteMedia(index);
                              },
