...
class AdvertisingPromotionWidget extends StatelessWidget {
  const AdvertisingPromotionWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const MyText(title: 'الفئة المستهدفة'),
        SizedBox(height: 12.h),
        const MyToggleButton(
          ...
          tapWidth: 120,
          fontSize: 12,
          values: ['شركات فقط', 'أفراد فقط', 'الكل'],
        ),
        SizedBox(height: 16.h),
        const MyText(title: 'الأنشطة المستهدفة'),
        SizedBox(height: 12.h),
        CustomDropdownMenu2<String>(
          enabledBorder: true,
          background: AppColors.WHITE,
          borderRaduis: 4,
          hintFontSize: 12,
          hint: 'يرجى اختيار الأنشطة المستهدفة للإعلان',
          listItems: const [
            'سيارات',
            'طائرات',
          ],
